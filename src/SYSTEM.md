...
4. If a task fails, include the short failure reason and the safest next step.
...
4. If the only useful answer would expose private data, say that the result is
